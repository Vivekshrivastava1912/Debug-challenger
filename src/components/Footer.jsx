  ...
  return (
    <footer className="bg-black text-white py-12 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        {/* Project Info */}
        <div>
          <h2 className="text-orange-500 font-bold text-xl mb-4">Debug Challenger</h2>
        ...
        {/* Debugging Topics */}
        <div>
          <h3 className="text-orange-500 font-semibold text-lg mb-3">Debugging Topics</h3>
        ...
        {/* DSA Topics */}
        <div>
          <h3 className="text-orange-500 font-semibold text-lg mb-3">DSA Topics</h3>
          <ul className="space-y-2 text-sm text-gray-300">
        ...
        {/* Developer Tools */}
        <div>
          <h3 className="text-orange-500 font-semibold text-lg mb-3">Developer Tools</h3>
          <ul className="space-y-2 text-sm text-gray-300">
            <li>React.js</li>
            <li>Vite</li>
            <li>Tailwind CSS</li>
